/*
 *Check the seekable information of the pipeline when it reaches PLAYING state.
 *Add timeout for function gst_bus_timed_pop_filtered() to do PTS print operation and seek operation,
 *Note that the timeout is very small to update the PTS information.
 *Print the PTS information in the same line.
 *The control flow by using flags.
*/
...
int main(int argc, char *argv[]) {
  ...
  /* Set the URI to play */
  g_object_set (data.playbin2, "uri", "file:///home/shena/share/media_data/1.mp4", NULL);
