...
-For both methods PKG_CONFIG_PATH is by default $(PREFIX)\lib\pkgconfig, where $(PREFIX)
 is by default <parent_dir_of_G-I_srcroot>\vs14\<PlatformName>.  If searching from
...
files to <root>\vs14\<PlatformName>\share\gir-1.0 (.gir files) and <root>\vs14\<PlatformName>\lib\girepository-1.0
(.typelib files)
...
<root>\vs14\<PlatformName>\lib and gobject-introspection headers into
<root>\vs14\<PlatformName>\include\gobject-introsection-1.0.
