				...
				while (TRUE) {
					...
					if (_tmp21_) {
						...
						if (_tmp28_) {
							...
							gchar* _tmp34_ = NULL;
							_tmp33_ = reader;
							_tmp34_ = vala_markup_reader_get_attribute (_tmp33_, "alias");
							_g_free0 (alias);
							alias = _tmp34_;
							state = 1;
						} else {
							...
							if (_tmp35_) {
								...
								_tmp38_ = reader;
								_tmp39_ = vala_markup_reader_get_content (_tmp38_);
								_tmp40_ = _tmp39_;
								_tmp41_ = g_strdup (_tmp40_);
								name = _tmp41_;
								_tmp42_ = gresource_dir;
								_tmp43_ = name;
...
static void vala_gtk_module_class_init (ValaGtkModuleClass * klass) {
	...
	((ValaCodeVisitorClass *) klass)->visit_property = vala_gtk_module_real_visit_property;
