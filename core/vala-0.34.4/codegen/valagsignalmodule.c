...
static ValaCCodeFunctionCall* vala_gsignal_module_real_get_signal_creation (ValaCCodeBaseModule* base, ValaSignal* sig, ValaTypeSymbol* type) {
	...
	_tmp45_ = sig;
	_tmp46_ = vala_code_node_get_attribute ((ValaCodeNode*) _tmp45_, "Deprecated");
	_tmp47_ = _tmp46_;
	...
	if (_tmp48_) {
		...
		gchar* _tmp50_ = NULL;
		_tmp49_ = flags;
		_tmp49__length1 = flags_length1;
		_tmp50_ = g_strdup ("G_SIGNAL_DEPRECATED");
		_vala_array_add8 (&flags, &flags_length1, &_flags_size_, _tmp50_);
	}
	_tmp51_ = csignew;
	_tmp52_ = flags;
	_tmp52__length1 = flags_length1;
	_tmp53_ = _vala_g_strjoinv (" | ", _tmp52_, _tmp52__length1);
	_tmp54_ = _tmp53_;
	...
	_g_free0 (_tmp54_);
	_tmp57_ = sig;
	_tmp58_ = vala_signal_get_default_handler (_tmp57_);
	_tmp59_ = _tmp58_;
	if (_tmp59_ == NULL) {
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp67_, VALA_TYPE_CLASS)) {
			...
			_tmp68_ = struct_offset;
			_tmp69_ = type;
			_tmp70_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp69_);
			_tmp71_ = _tmp70_;
			_tmp72_ = g_strdup_printf ("%sClass", _tmp71_);
			_tmp73_ = _tmp72_;
			_tmp74_ = vala_ccode_identifier_new (_tmp73_);
			_tmp75_ = _tmp74_;
			vala_ccode_function_call_add_argument (_tmp68_, (ValaCCodeExpression*) _tmp75_);
			_vala_ccode_node_unref0 (_tmp75_);
			_g_free0 (_tmp73_);
			_g_free0 (_tmp71_);
		} else {
			...
			_tmp77_ = type;
			_tmp78_ = vala_ccode_base_module_get_ccode_type_name (G_TYPE_CHECK_INSTANCE_CAST (_tmp77_, VALA_TYPE_INTERFACE, ValaInterface));
			_tmp79_ = _tmp78_;
		...
		_tmp82_ = struct_offset;
		_tmp83_ = sig;
		_tmp84_ = vala_signal_get_default_handler (_tmp83_);
		_tmp85_ = _tmp84_;
		_tmp86_ = vala_ccode_base_module_get_ccode_vfunc_name (_tmp85_);
		_tmp87_ = _tmp86_;
	...
	_tmp95_ = csignew;
	_tmp96_ = vala_ccode_constant_new ("NULL");
	_tmp97_ = _tmp96_;
	vala_ccode_function_call_add_argument (_tmp95_, (ValaCCodeExpression*) _tmp97_);
	_vala_ccode_node_unref0 (_tmp97_);
	_tmp98_ = sig;
	_tmp99_ = vala_signal_get_parameters (_tmp98_);
	_tmp100_ = _tmp99_;
	_tmp101_ = sig;
	_tmp102_ = vala_signal_get_return_type (_tmp101_);
	_tmp103_ = _tmp102_;
	_tmp104_ = vala_gsignal_module_get_marshaller_function (self, _tmp100_, _tmp103_, NULL);
	_tmp105_ = _tmp104_;
	_vala_iterable_unref0 (_tmp100_);
	marshaller = _tmp105_;
	_tmp106_ = marshaller;
	_tmp107_ = vala_ccode_identifier_new (_tmp106_);
	marshal_arg = _tmp107_;
	_tmp108_ = csignew;
	_tmp109_ = marshal_arg;
	vala_ccode_function_call_add_argument (_tmp108_, (ValaCCodeExpression*) _tmp109_);
	_tmp110_ = sig;
	_tmp111_ = vala_signal_get_parameters (_tmp110_);
	params = _tmp111_;
	_tmp113_ = sig;
	_tmp114_ = vala_signal_get_return_type (_tmp113_);
	_tmp115_ = _tmp114_;
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp115_, VALA_TYPE_POINTER_TYPE)) {
		_tmp112_ = TRUE;
	} else {
		ValaSignal* _tmp116_ = NULL;
		ValaDataType* _tmp117_ = NULL;
		ValaDataType* _tmp118_ = NULL;
		ValaTypeParameter* _tmp119_ = NULL;
		ValaTypeParameter* _tmp120_ = NULL;
		_tmp116_ = sig;
		_tmp117_ = vala_signal_get_return_type (_tmp116_);
		_tmp118_ = _tmp117_;
		_tmp119_ = vala_data_type_get_type_parameter (_tmp118_);
		_tmp120_ = _tmp119_;
	...
	if (_tmp112_) {
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp126_, VALA_TYPE_ERROR_TYPE)) {
			...
			if (_tmp134_ == NULL) {
				...
				_tmp135_ = csignew;
				_tmp136_ = vala_ccode_constant_new ("G_TYPE_NONE");
				_tmp137_ = _tmp136_;
				...
				_tmp138_ = csignew;
				_tmp139_ = sig;
				_tmp140_ = vala_signal_get_return_type (_tmp139_);
				_tmp141_ = _tmp140_;
				_tmp142_ = vala_data_type_get_data_type (_tmp141_);
				_tmp143_ = _tmp142_;
				_tmp144_ = vala_ccode_base_module_get_ccode_type_id ((ValaCodeNode*) _tmp143_);
				_tmp145_ = _tmp144_;
				_tmp146_ = vala_ccode_constant_new (_tmp145_);
				_tmp147_ = _tmp146_;
				vala_ccode_function_call_add_argument (_tmp138_, (ValaCCodeExpression*) _tmp147_);
	...
	params_len = 0;
	{
		...
		while (TRUE) {
			...
			_tmp162_ = _tmp161_;
			_tmp163_ = vala_data_type_is_array (_tmp162_);
			if (_tmp163_) {
				gint _tmp164_ = 0;
				_tmp164_ = params_len;
				params_len = _tmp164_ + 1;
			}
	...
	_tmp165_ = csignew;
	_tmp166_ = params_len;
	_tmp167_ = g_strdup_printf ("%d", _tmp166_);
	_tmp168_ = _tmp167_;
	...
	_g_free0 (_tmp168_);
	{
		...
		while (TRUE) {
			...
			_tmp182_ = param;
			_tmp183_ = vala_variable_get_variable_type ((ValaVariable*) _tmp182_);
			_tmp184_ = _tmp183_;
			_tmp185_ = vala_data_type_is_array (_tmp184_);
			if (_tmp185_) {
				...
				_tmp188_ = _tmp187_;
				_tmp189_ = vala_array_type_get_element_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp188_, VALA_TYPE_ARRAY_TYPE, ValaArrayType));
				_tmp190_ = _tmp189_;
				_tmp191_ = vala_data_type_get_data_type (_tmp190_);
				_tmp192_ = _tmp191_;
				_tmp193_ = ((ValaCCodeBaseModule*) self)->string_type;
				_tmp194_ = vala_data_type_get_data_type (_tmp193_);
				_tmp195_ = _tmp194_;
				if (_tmp192_ == _tmp195_) {
					...
					_tmp196_ = csignew;
					_tmp197_ = vala_ccode_constant_new ("G_TYPE_STRV");
					_tmp198_ = _tmp197_;
					...
					_tmp199_ = csignew;
					_tmp200_ = vala_ccode_constant_new ("G_TYPE_POINTER");
					_tmp201_ = _tmp200_;
					vala_ccode_function_call_add_argument (_tmp199_, (ValaCCodeExpression*) _tmp201_);
					_vala_ccode_node_unref0 (_tmp201_);
				}
				_tmp202_ = csignew;
				_tmp203_ = vala_ccode_constant_new ("G_TYPE_INT");
				_tmp204_ = _tmp203_;
				...
				_tmp209_ = _tmp208_;
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp209_, VALA_TYPE_POINTER_TYPE)) {
					_tmp206_ = TRUE;
				} else {
					ValaParameter* _tmp210_ = NULL;
					ValaDataType* _tmp211_ = NULL;
					ValaDataType* _tmp212_ = NULL;
					ValaTypeParameter* _tmp213_ = NULL;
					ValaTypeParameter* _tmp214_ = NULL;
					_tmp210_ = param;
					_tmp211_ = vala_variable_get_variable_type ((ValaVariable*) _tmp210_);
					_tmp212_ = _tmp211_;
					_tmp213_ = vala_data_type_get_type_parameter (_tmp212_);
					_tmp214_ = _tmp213_;
					_tmp206_ = _tmp214_ != NULL;
				}
				if (_tmp206_) {
					_tmp205_ = TRUE;
				} else {
					...
					ValaParameterDirection _tmp217_ = 0;
					_tmp215_ = param;
					_tmp216_ = vala_parameter_get_direction (_tmp215_);
					_tmp217_ = _tmp216_;
					_tmp205_ = _tmp217_ != VALA_PARAMETER_DIRECTION_IN;
				}
				if (_tmp205_) {
					...
					if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp223_, VALA_TYPE_ERROR_TYPE)) {
						...
						_tmp232_ = _tmp231_;
						_tmp233_ = vala_ccode_base_module_get_ccode_type_id ((ValaCodeNode*) _tmp232_);
						_tmp234_ = _tmp233_;
						_tmp235_ = vala_ccode_constant_new (_tmp234_);
						_tmp236_ = _tmp235_;
						vala_ccode_function_call_add_argument (_tmp227_, (ValaCCodeExpression*) _tmp236_);
	...
	_tmp237_ = marshal_arg;
	_tmp238_ = marshaller;
	vala_ccode_identifier_set_name (_tmp237_, _tmp238_);
	result = csignew;
...
"GNAL_MATCH_DATA");
			...
			if (!G_TYPE_CHECK_INSTANCE_TYPE (_tmp114_, VALA_TYPE_ELEMENT_ACCESS)) {
				...
				_tmp129_ = _tmp128_;
				_tmp130_ = vala_ccode_unary_expression_new (VALA_CCODE_UNARY_OPERATOR_ADDRESS_OF, _tmp129_);
				_tmp131_ = _tmp130_;
