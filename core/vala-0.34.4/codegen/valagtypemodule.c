...
static void vala_gtype_module_begin_class_init_function (ValaGTypeModule* self, ValaClass* cl) {
	...
	}
	{
		...
		while (TRUE) {
			...
			_tmp277_ = _tmp276_;
			_tmp278_ = vala_ccode_base_module_get_ccode_no_accessor_method (_tmp277_);
			if (!_tmp278_) {
				ValaProperty* _tmp279_ = NULL;
				ValaProperty* _tmp280_ = NULL;
				ValaProperty* _tmp281_ = NULL;
				gboolean _tmp282_ = FALSE;
				_tmp279_ = prop;
				_tmp280_ = vala_property_get_base_property (_tmp279_);
				_tmp281_ = _tmp280_;
				_tmp282_ = vala_ccode_base_module_get_ccode_concrete_accessor (_tmp281_);
				_tmp274_ = !_tmp282_;
			} else {
				_tmp274_ = FALSE;
			}
			if (_tmp274_) {
				...
				ValaPropertyAccessor* _tmp305_ = NULL;
				_tmp283_ = prop;
				...
				if (_tmp285_ != NULL) {
					...
					gchar* _tmp296_ = NULL;
					gchar* _tmp297_ = NULL;
					ValaCCodeMemberAccess* _tmp298_ = NULL;
					...
					_tmp288_ = _tmp287_;
					_tmp289_ = vala_ccode_base_module_get_ccode_real_name ((ValaSymbol*) _tmp288_);
					cname = _tmp289_;
					...
					_tmp295_ = _tmp294_;
					_tmp296_ = g_strdup_printf ("get_%s", _tmp295_);
					_tmp297_ = _tmp296_;
				...
				if (_tmp305_ != NULL) {
					...
					gchar* _tmp316_ = NULL;
					gchar* _tmp317_ = NULL;
					ValaCCodeMemberAccess* _tmp318_ = NULL;
					ValaCCodeMemberAccess* _tmp319_ = NULL;
					...
					_tmp308_ = _tmp307_;
					_tmp309_ = vala_ccode_base_module_get_ccode_real_name ((ValaSymbol*) _tmp308_);
					cname = _tmp309_;
					...
					_tmp315_ = _tmp314_;
					_tmp316_ = g_strdup_printf ("set_%s", _tmp315_);
					_tmp317_ = _tmp316_;
					_tmp318_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp312_, _tmp317_);
					_tmp319_ = _tmp318_;
					_tmp320_ = cname;
					_tmp321_ = vala_ccode_identifier_new (_tmp320_);
					_tmp322_ = _tmp321_;
					vala_ccode_function_add_assignment (_tmp311_, (ValaCCodeExpression*) _tmp319_, (ValaCCodeExpression*) _tmp322_);
	...
	_tmp323_ = cl;
	vala_gtype_module_generate_class_init (self, _tmp323_);
	_tmp324_ = cl;
	_tmp325_ = vala_class_get_is_compact (_tmp324_);
	_tmp326_ = _tmp325_;
	if (!_tmp326_) {
		{
			ValaList* _sig_list = NULL;
			...
			gint _sig_index = 0;
			_tmp327_ = cl;
			_tmp328_ = vala_object_type_symbol_get_signals ((ValaObjectTypeSymbol*) _tmp327_);
			_sig_list = _tmp328_;
			_tmp329_ = _sig_list;
			...
			while (TRUE) {
				...
				ValaClass* _tmp353_ = NULL;
				ValaCCodeFunctionCall* _tmp354_ = NULL;
				ValaCCodeFunctionCall* _tmp355_ = NULL;
				_tmp332_ = _sig_index;
				_sig_index = _tmp332_ + 1;
				_tmp333_ = _sig_index;
				_tmp334_ = _sig_size;
				...
				if (_tmp340_ != NULL) {
					...
					ValaSignal* _tmp343_ = NULL;
					ValaComment* _tmp344_ = NULL;
					ValaComment* _tmp345_ = NULL;
					const gchar* _tmp346_ = NULL;
					const gchar* _tmp347_ = NULL;
					ValaCCodeComment* _tmp348_ = NULL;
					ValaCCodeComment* _tmp349_ = NULL;
					_tmp341_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
					_tmp342_ = _tmp341_;
					_tmp343_ = sig;
					_tmp344_ = vala_symbol_get_comment ((ValaSymbol*) _tmp343_);
					_tmp345_ = _tmp344_;
					_tmp346_ = vala_comment_get_content (_tmp345_);
					_tmp347_ = _tmp346_;
					_tmp348_ = vala_ccode_comment_new (_tmp347_);
					_tmp349_ = _tmp348_;
					vala_ccode_function_add_statement (_tmp342_, (ValaCCodeNode*) _tmp349_);
				...
				_tmp352_ = sig;
				_tmp353_ = cl;
				_tmp354_ = vala_ccode_base_module_get_signal_creation ((ValaCCodeBaseModule*) self, _tmp352_, (ValaTypeSymbol*) _tmp353_);
				_tmp355_ = _tmp354_;
...
static void vala_gtype_module_add_interface_init_function (ValaGTypeModule* self, ValaClass* cl, ValaInterface* iface) {
	...
	}
	{
		...
		while (TRUE) {
			...
			ciface = _tmp300_;
			_tmp302_ = prop;
			_tmp303_ = vala_property_get_base_interface_property (_tmp302_);
			_tmp304_ = _tmp303_;
			_tmp305_ = vala_ccode_base_module_get_ccode_no_accessor_method (_tmp304_);
			if (!_tmp305_) {
				ValaProperty* _tmp306_ = NULL;
				...
				_tmp308_ = _tmp307_;
				_tmp309_ = vala_ccode_base_module_get_ccode_concrete_accessor (_tmp308_);
				_tmp301_ = !_tmp309_;
			} else {
				_tmp301_ = FALSE;
			}
			if (_tmp301_) {
				...
				if (_tmp312_ != NULL) {
					...
					_tmp315_ = _tmp314_;
					_tmp316_ = vala_ccode_base_module_get_ccode_real_name ((ValaSymbol*) _tmp315_);
					cname = _tmp316_;
					_tmp318_ = prop;
					_tmp319_ = vala_property_get_is_abstract (_tmp318_);
					_tmp320_ = _tmp319_;
					if (_tmp320_) {
						_tmp317_ = TRUE;
					} else {
						...
						_tmp321_ = prop;
						_tmp322_ = vala_property_get_is_virtual (_tmp321_);
						_tmp323_ = _tmp322_;
						_tmp317_ = _tmp323_;
					}
					if (_tmp317_) {
					...
					if (_tmp330_) {
						...
						ValaPropertyAccessor* _tmp338_ = NULL;
				...
				if (_tmp356_ != NULL) {
					...
					ValaCCodeExpression* _tmp397_ = NULL;
					_tmp357_ = prop;
					...
					if (_tmp361_) {
						ValaProperty* _tmp368_ = NULL;
						ValaPropertyAccessor* _tmp369_ = NULL;
						ValaPropertyAccessor* _tmp370_ = NULL;
						gchar* _tmp371_ = NULL;
						_tmp368_ = prop;
						_tmp369_ = vala_property_get_set_accessor (_tmp368_);
						_tmp370_ = _tmp369_;
					...
					cfunc = (ValaCCodeExpression*) _tmp373_;
					_tmp375_ = prop;
					...
					if (_tmp377_) {
						...
						ValaProperty* _tmp378_ = NULL;
						gboolean _tmp379_ = FALSE;
						gboolean _tmp380_ = FALSE;
						_tmp378_ = prop;
						_tmp379_ = vala_property_get_is_virtual (_tmp378_);
						_tmp380_ = _tmp379_;
						_tmp374_ = _tmp380_;
					}
					if (_tmp374_) {
						...
						ValaPropertyAccessor* _tmp383_ = NULL;
						...
						_tmp384_ = cfunc;
						_tmp385_ = base_type;
						_tmp386_ = vala_gtype_module_cast_property_accessor_pointer (self, _tmp383_, _tmp384_, _tmp385_);
						_vala_ccode_node_unref0 (cfunc);
						cfunc = _tmp386_;
					}
					...
					_tmp392_ = _tmp391_;
					_tmp393_ = g_strdup_printf ("set_%s", _tmp392_);
					_tmp394_ = _tmp393_;
					_tmp395_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp389_, _tmp394_);
					_tmp396_ = _tmp395_;
					_tmp397_ = cfunc;
					vala_ccode_function_add_assignment (_tmp388_, (ValaCCodeExpression*) _tmp396_, _tmp397_);
	...
	}
	{
		...
		gint _prop_index = 0;
		_tmp398_ = iface;
		_tmp399_ = vala_object_type_symbol_get_properties ((ValaObjectTypeSymbol*) _tmp398_);
		_prop_list = _tmp399_;
		_tmp400_ = _prop_list;
		...
		while (TRUE) {
			...
			_tmp403_ = _prop_index;
			_prop_index = _tmp403_ + 1;
			_tmp404_ = _prop_index;
			_tmp405_ = _prop_size;
			...
			_tmp408_ = vala_list_get (_tmp406_, _tmp407_);
			prop = (ValaProperty*) _tmp408_;
			_tmp409_ = prop;
			_tmp410_ = vala_property_get_is_abstract (_tmp409_);
			_tmp411_ = _tmp410_;
			if (!_tmp411_) {
				_vala_code_node_unref0 (prop);
				continue;
			...
			while (TRUE) {
				...
				ValaClass* _tmp417_ = NULL;
				ValaScope* _tmp418_ = NULL;
				ValaScope* _tmp419_ = NULL;
				...
				_tmp417_ = base_class;
				_tmp418_ = vala_symbol_get_scope ((ValaSymbol*) _tmp417_);
				_tmp419_ = _tmp418_;
				_tmp420_ = prop;
				_tmp421_ = vala_symbol_get_name ((ValaSymbol*) _tmp420_);
				_tmp422_ = _tmp421_;
				_tmp423_ = vala_scope_lookup (_tmp419_, _tmp422_);
				_tmp424_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp423_, VALA_TYPE_PROPERTY) ? ((ValaProperty*) _tmp423_) : NULL;
				if (_tmp424_ == NULL) {
				...
				cl_prop = _tmp424_;
				_tmp425_ = base_class;
				_tmp426_ = vala_class_get_base_class (_tmp425_);
				_tmp427_ = _tmp426_;
			...
			if (_tmp430_ != NULL) {
				...
				_tmp431_ = cl_prop;
				_tmp432_ = vala_symbol_get_parent_symbol ((ValaSymbol*) _tmp431_);
				_tmp433_ = _tmp432_;
				_tmp434_ = cl;
				_tmp429_ = _tmp433_ != G_TYPE_CHECK_INSTANCE_CAST (_tmp434_, VALA_TYPE_SYMBOL, ValaSymbol);
			} else {
				_tmp429_ = FALSE;
			}
			if (_tmp429_) {
				...
				ValaPropertyAccessor* _tmp484_ = NULL;
				_tmp435_ = cl_prop;
				_tmp436_ = _vala_code_node_ref0 (_tmp435_);
				base_property = _tmp436_;
				_tmp437_ = cl_prop;
				_tmp438_ = vala_property_get_base_property (_tmp437_);
				_tmp439_ = _tmp438_;
				if (_tmp439_ != NULL) {
					...
					base_property = _tmp443_;
				} else {
					ValaProperty* _tmp444_ = NULL;
					ValaProperty* _tmp445_ = NULL;
					ValaProperty* _tmp446_ = NULL;
					_tmp444_ = cl_prop;
					_tmp445_ = vala_property_get_base_interface_property (_tmp444_);
					_tmp446_ = _tmp445_;
					if (_tmp446_ != NULL) {
						...
						_vala_code_node_unref0 (base_property);
						base_property = _tmp450_;
					}
				}
				_tmp451_ = vala_ccode_identifier_new ("iface");
				ciface = _tmp451_;
				_tmp452_ = base_property;
				_tmp453_ = vala_property_get_get_accessor (_tmp452_);
				_tmp454_ = _tmp453_;
				if (_tmp454_ != NULL) {
					ValaProperty* _tmp455_ = NULL;
					ValaPropertyAccessor* _tmp456_ = NULL;
					ValaPropertyAccessor* _tmp457_ = NULL;
					ValaCCodeFile* _tmp458_ = NULL;
					gchar* cname = NULL;
					ValaProperty* _tmp459_ = NULL;
					ValaPropertyAccessor* _tmp460_ = NULL;
					...
					ValaCCodeMemberAccess* _tmp480_ = NULL;
					ValaCCodeExpression* _tmp481_ = NULL;
					_tmp455_ = base_property;
					_tmp456_ = vala_property_get_get_accessor (_tmp455_);
					_tmp457_ = _tmp456_;
					_tmp458_ = ((ValaCCodeBaseModule*) self)->cfile;
					vala_ccode_base_module_generate_property_accessor_declaration ((ValaCCodeBaseModule*) self, _tmp457_, _tmp458_);
					_tmp459_ = base_property;
					_tmp460_ = vala_property_get_get_accessor (_tmp459_);
					_tmp461_ = _tmp460_;
					_tmp462_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp461_);
					cname = _tmp462_;
					_tmp463_ = cname;
					_tmp464_ = vala_ccode_identifier_new (_tmp463_);
					cfunc = (ValaCCodeExpression*) _tmp464_;
					_tmp465_ = prop;
					_tmp466_ = vala_property_get_get_accessor (_tmp465_);
					_tmp467_ = _tmp466_;
					_tmp468_ = cfunc;
					_tmp469_ = iface;
					_tmp470_ = vala_gtype_module_cast_property_accessor_pointer (self, _tmp467_, _tmp468_, (ValaObjectTypeSymbol*) _tmp469_);
					_vala_ccode_node_unref0 (cfunc);
					cfunc = _tmp470_;
					...
					_tmp476_ = _tmp475_;
					_tmp477_ = g_strdup_printf ("get_%s", _tmp476_);
					_tmp478_ = _tmp477_;
					_tmp479_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp473_, _tmp478_);
					_tmp480_ = _tmp479_;
					_tmp481_ = cfunc;
					vala_ccode_function_add_assignment (_tmp472_, (ValaCCodeExpression*) _tmp480_, _tmp481_);
					_vala_ccode_node_unref0 (_tmp480_);
					_g_free0 (_tmp478_);
					_vala_ccode_node_unref0 (cfunc);
					_g_free0 (cname);
				}
				_tmp482_ = base_property;
				_tmp483_ = vala_property_get_set_accessor (_tmp482_);
				_tmp484_ = _tmp483_;
				if (_tmp484_ != NULL) {
					ValaProperty* _tmp485_ = NULL;
					ValaPropertyAccessor* _tmp486_ = NULL;
					ValaPropertyAccessor* _tmp487_ = NULL;
					ValaCCodeFile* _tmp488_ = NULL;
					gchar* cname = NULL;
					...
					ValaPropertyAccessor* _tmp497_ = NULL;
					ValaCCodeExpression* _tmp498_ = NULL;
					ValaInterface* _tmp499_ = NULL;
					...
					gchar* _tmp507_ = NULL;
					gchar* _tmp508_ = NULL;
					ValaCCodeMemberAccess* _tmp509_ = NULL;
					ValaCCodeMemberAccess* _tmp510_ = NULL;
					ValaCCodeExpression* _tmp511_ = NULL;
					_tmp485_ = base_property;
					_tmp486_ = vala_property_get_set_accessor (_tmp485_);
					_tmp487_ = _tmp486_;
					_tmp488_ = ((ValaCCodeBaseModule*) self)->cfile;
					vala_ccode_base_module_generate_property_accessor_declaration ((ValaCCodeBaseModule*) self, _tmp487_, _tmp488_);
					_tmp489_ = base_property;
					_tmp490_ = vala_property_get_set_accessor (_tmp489_);
					_tmp491_ = _tmp490_;
					_tmp492_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp491_);
					cname = _tmp492_;
					_tmp493_ = cname;
					_tmp494_ = vala_ccode_identifier_new (_tmp493_);
					cfunc = (ValaCCodeExpression*) _tmp494_;
					_tmp495_ = prop;
					_tmp496_ = vala_property_get_set_accessor (_tmp495_);
					_tmp497_ = _tmp496_;
					_tmp498_ = cfunc;
					_tmp499_ = iface;
					_tmp500_ = vala_gtype_module_cast_property_accessor_pointer (self, _tmp497_, _tmp498_, (ValaObjectTypeSymbol*) _tmp499_);
					_vala_ccode_node_unref0 (cfunc);
					cfunc = _tmp500_;
					_tmp501_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
					_tmp502_ = _tmp501_;
					_tmp503_ = ciface;
					_tmp504_ = prop;
					_tmp505_ = vala_symbol_get_name ((ValaSymbol*) _tmp504_);
					_tmp506_ = _tmp505_;
					_tmp507_ = g_strdup_printf ("set_%s", _tmp506_);
					_tmp508_ = _tmp507_;
					_tmp509_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp503_, _tmp508_);
					_tmp510_ = _tmp509_;
					_tmp511_ = cfunc;
					vala_ccode_function_add_assignment (_tmp502_, (ValaCCodeExpression*) _tmp510_, _tmp511_);
	...
	vala_ccode_base_module_pop_function ((ValaCCodeBaseModule*) self);
	_tmp512_ = ((ValaCCodeBaseModule*) self)->cfile;
	_tmp513_ = iface_init;
	vala_ccode_file_add_function (_tmp512_, _tmp513_);
	_vala_ccode_node_unref0 (parent_var_decl);
	_vala_ccode_node_unref0 (parent_decl);
...
static void vala_gtype_module_real_visit_method_call (ValaCodeVisitor* base, ValaMethodCall* expr) {
	...
	ValaCType* _tmp58_ = NULL;
	ValaCType* _tmp59_ = NULL;
	...
	ValaCCodeBinaryExpression* _tmp112_ = NULL;
	...
	ValaCCodeIdentifier* _tmp120_ = NULL;
	ValaCCodeIdentifier* _tmp121_ = NULL;
	ValaCCodeConditionalExpression* _tmp122_ = NULL;
	ValaCCodeConditionalExpression* _tmp123_ = NULL;
	self = (ValaGTypeModule*) base;
	...
	_tmp48_ = _tmp47_;
	_tmp49_ = vala_value_type_get_type_symbol ((ValaValueType*) G_TYPE_CHECK_INSTANCE_CAST (_tmp48_, VALA_TYPE_ENUM_VALUE_TYPE, ValaEnumValueType));
	_tmp50_ = _tmp49_;
	_tmp51_ = vala_enum_get_is_flags (G_TYPE_CHECK_INSTANCE_CAST (_tmp50_, VALA_TYPE_ENUM, ValaEnum));
	_tmp52_ = _tmp51_;
	is_flags = _tmp52_;
	_tmp53_ = expr;
	_tmp54_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp53_);
	_tmp55_ = _tmp54_;
	vala_ccode_base_module_push_line ((ValaCCodeBaseModule*) self, _tmp55_);
	_tmp57_ = is_flags;
	if (_tmp57_) {
		_tmp56_ = "GFlagsValue*";
	} else {
	...
	_tmp58_ = vala_ctype_new (_tmp56_);
	_tmp59_ = _tmp58_;
	_tmp60_ = expr;
	_tmp61_ = vala_ccode_base_module_get_temp_variable ((ValaCCodeBaseModule*) self, (ValaDataType*) _tmp59_, FALSE, (ValaCodeNode*) _tmp60_, FALSE);
	_tmp62_ = _tmp61_;
	_vala_code_node_unref0 (_tmp59_);
	temp_var = _tmp62_;
	_tmp63_ = temp_var;
	vala_ccode_base_module_emit_temp_var ((ValaCCodeBaseModule*) self, _tmp63_);
	_tmp64_ = vala_ccode_identifier_new ("g_type_class_ref");
	_tmp65_ = _tmp64_;
	...
	_tmp73_ = _tmp72_;
	_tmp74_ = vala_ccode_base_module_get_ccode_type_id ((ValaCodeNode*) _tmp73_);
	_tmp75_ = _tmp74_;
	_tmp76_ = vala_ccode_identifier_new (_tmp75_);
	_tmp77_ = _tmp76_;
	vala_ccode_function_call_add_argument (_tmp68_, (ValaCCodeExpression*) _tmp77_);
	_vala_ccode_node_unref0 (_tmp77_);
	_g_free0 (_tmp75_);
	_tmp79_ = is_flags;
	if (_tmp79_) {
		_tmp78_ = "g_flags_get_first_value";
	} else {
		_tmp78_ = "g_enum_get_value";
	}
	_tmp80_ = vala_ccode_identifier_new (_tmp78_);
	_tmp81_ = _tmp80_;
	_tmp82_ = vala_ccode_function_call_new ((ValaCCodeExpression*) _tmp81_);
	_tmp83_ = _tmp82_;
	_vala_ccode_node_unref0 (_tmp81_);
	...
	_tmp86_ = get_value;
	_tmp87_ = expr;
	_tmp88_ = vala_method_call_get_call (_tmp87_);
	_tmp89_ = _tmp88_;
	_tmp90_ = vala_member_access_get_inner (G_TYPE_CHECK_INSTANCE_CAST (_tmp89_, VALA_TYPE_MEMBER_ACCESS, ValaMemberAccess));
	_tmp91_ = _tmp90_;
	_tmp92_ = vala_ccode_base_module_get_ccodenode ((ValaCCodeBaseModule*) self, _tmp91_);
	_tmp93_ = G_TYPE_CHECK_INSTANCE_CAST (_tmp92_, VALA_TYPE_CCODE_EXPRESSION, ValaCCodeExpression);
	vala_ccode_function_call_add_argument (_tmp86_, _tmp93_);
	_vala_ccode_node_unref0 (_tmp93_);
	...
	_tmp100_ = _tmp99_;
	_tmp101_ = get_value;
	vala_ccode_function_add_assignment (_tmp95_, _tmp100_, (ValaCCodeExpression*) _tmp101_);
	_vala_ccode_node_unref0 (_tmp100_);
	_tmp102_ = temp_var;
	...
	_tmp108_ = _tmp107_;
	_tmp109_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_INEQUALITY, _tmp106_, (ValaCCodeExpression*) _tmp108_);
	_tmp110_ = _tmp109_;
	_vala_ccode_node_unref0 (_tmp108_);
	_vala_ccode_node_unref0 (_tmp106_);
	is_null_value = _tmp110_;
	_tmp111_ = expr;
	_tmp112_ = is_null_value;
	_tmp113_ = temp_var;
	...
	_tmp117_ = _tmp116_;
	_tmp118_ = vala_ccode_member_access_new_pointer (_tmp117_, "value_name");
	_tmp119_ = _tmp118_;
	_tmp120_ = vala_ccode_identifier_new ("NULL");
	_tmp121_ = _tmp120_;
	_tmp122_ = vala_ccode_conditional_expression_new ((ValaCCodeExpression*) _tmp112_, (ValaCCodeExpression*) _tmp119_, (ValaCCodeExpression*) _tmp121_);
	_tmp123_ = _tmp122_;
	vala_ccode_base_module_set_cvalue ((ValaCCodeBaseModule*) self, (ValaExpression*) _tmp111_, (ValaCCodeExpression*) _tmp123_);
...
static void vala_gtype_module_real_visit_property (ValaCodeVisitor* base, ValaProperty* prop) {
	...
	base_prop = _tmp7_;
	_tmp8_ = prop;
	_tmp9_ = vala_property_get_base_property (_tmp8_);
	_tmp10_ = _tmp9_;
	if (_tmp10_ != NULL) {
		...
		_tmp11_ = prop;
		_tmp12_ = vala_property_get_base_property (_tmp11_);
		_tmp13_ = _tmp12_;
		...
		_tmp15_ = prop;
		_tmp16_ = vala_property_get_base_interface_property (_tmp15_);
		_tmp17_ = _tmp16_;
		if (_tmp17_ != NULL) {
			...
			_tmp18_ = prop;
			_tmp19_ = vala_property_get_base_interface_property (_tmp18_);
			_tmp20_ = _tmp19_;
	...
	_tmp24_ = base_prop;
	_tmp25_ = vala_code_node_get_attribute ((ValaCodeNode*) _tmp24_, "NoAccessorMethod");
	_tmp26_ = _tmp25_;
	...
	if (_tmp27_) {
		...
		_tmp30_ = _tmp29_;
		_tmp23_ = g_strcmp0 (_tmp30_, "type") == 0;
	} else {
		_tmp23_ = FALSE;
	}
	if (_tmp23_) {
		...
		if (_tmp32_) {
			...
			if (_tmp38_ != NULL) {
				...
				gboolean _tmp40_ = FALSE;
				_tmp39_ = st;
				_tmp40_ = vala_ccode_base_module_get_ccode_has_type_id ((ValaTypeSymbol*) _tmp39_);
				_tmp37_ = _tmp40_;
			} else {
				_tmp37_ = FALSE;
			}
	...
	if (_tmp22_) {
		...
		_tmp43_ = _tmp42_;
		vala_report_error (_tmp43_, "Property 'type' not allowed");
		_vala_code_node_unref0 (base_prop);
		_vala_code_node_unref0 (st);
	...
	_tmp44_ = prop;
	VALA_CODE_VISITOR_CLASS (vala_gtype_module_parent_class)->visit_property ((ValaCodeVisitor*) G_TYPE_CHECK_INSTANCE_CAST (self, VALA_TYPE_GERROR_MODULE, ValaGErrorModule), _tmp44_);
	_vala_code_node_unref0 (base_prop);
	_vala_code_node_unref0 (st);
	_vala_code_node_unref0 (cl);
}
