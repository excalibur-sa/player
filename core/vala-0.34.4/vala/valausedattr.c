...
static void vala_used_attr_check_unused_attr (ValaUsedAttr* self, ValaSymbol* sym);
...
static void vala_used_attr_real_visit_namespace (ValaCodeVisitor* base, ValaNamespace* ns);
void vala_code_node_accept_children (ValaCodeNode* self, ValaCodeVisitor* visitor);
static void vala_used_attr_real_visit_class (ValaCodeVisitor* base, ValaClass* cl);
static void vala_used_attr_real_visit_struct (ValaCodeVisitor* base, ValaStruct* st);
static void vala_used_attr_real_visit_interface (ValaCodeVisitor* base, ValaInterface* iface);
static void vala_used_attr_real_visit_enum (ValaCodeVisitor* base, ValaEnum* en);
static void vala_used_attr_real_visit_error_domain (ValaCodeVisitor* base, ValaErrorDomain* ed);
static void vala_used_attr_real_visit_delegate (ValaCodeVisitor* base, ValaDelegate* cb);
static void vala_used_attr_real_visit_constant (ValaCodeVisitor* base, ValaConstant* c);
static void vala_used_attr_real_visit_field (ValaCodeVisitor* base, ValaField* f);
static void vala_used_attr_real_visit_method (ValaCodeVisitor* base, ValaMethod* m);
static void vala_used_attr_real_visit_creation_method (ValaCodeVisitor* base, ValaCreationMethod* m);
static void vala_used_attr_real_visit_formal_parameter (ValaCodeVisitor* base, ValaParameter* p);
static void vala_used_attr_real_visit_property (ValaCodeVisitor* base, ValaProperty* prop);
static void vala_used_attr_real_visit_signal (ValaCodeVisitor* base, ValaSignal* sig);
static void vala_used_attr_finalize (ValaCodeVisitor* obj);

static const gchar* VALA_USED_ATTR_valac_default_attrs[155] = {"CCode", "type_signature", "default_value", "set_value_function", "type_id", "cprefix", "cheader_filename", "marshaller_type_name", "get_value_function", "cname", "cheader_filename", "destroy_function", "lvalue_access", "has_type_id", "instance_pos", "const_cname", "take_value_function", "copy_function", "free_function", "param_spec_function", "has_target", "type_cname", "ref_function", "ref_function_void", "unref_function", "type", "has_construct_function", "returns_floating_reference", "gir_namespace", "gir_version", "construct_function", "lower_case_cprefix", "simple_generics", "sentinel", "scope", "has_destroy_function", "ordering", "type_check_function", "has_copy_function", "lower_case_csuffix", "ref_sink_function", "dup_function", "finish_function", "generic_type_pos", "array_length_type", "array_length", "array_length_cname", "array_length_cexpr", "array_null_terminated", "vfunc_name", "finish_vfunc_name", "finish_name", "free_function_address_of", "pos", "delegate_target", "delegate_target_cname", "array_length_pos", "delegate_target_pos", "destroy_notify_pos", "ctype", "has_new_function", "notify", "", "Immutable", "", "Compact", "", "NoWrapper", "", "DestroysInstance", "", "Flags", "", "Experimental", "", "NoReturn", "", "Assert", "", "ErrorBase", "", "GenericAccessors", "", "Diagnostics", "", "NoAccessorMethod", "", "ConcreteAccessor", "", "HasEmitter", "", "ReturnsModifiedPointer", "", "Deprecated", "since", "replacement", "", "Version", "since", "replacement", "deprecated", "deprecated_since", "experimental", "", "Signal", "detailed", "run", "no_recurse", "action", "no_hooks", "", "Description", "nick", "blurb", "", "IntegerType", "rank", "min", "max", "", "FloatingType", "rank", "", "BooleanType", "", "SimpleType", "", "PrintfFormat", "", "ScanfFormat", "", "GtkChild", "name", "internal", "", "GtkTemplate", "ui", "", "GtkCallback", "name", "", "DBus", "name", "no_reply", "result", "use_string_marshalling", "value", "signature", "visible", "timeout", "", "GIR", "fullname", "name", ""};
...
void vala_used_attr_mark (ValaUsedAttr* self, const gchar* attribute, const gchar* argument) {
	...
	if (_tmp3_ == NULL) {
		...
		_tmp8_ = attribute;
		_tmp9_ = set;
		vala_map_set (_tmp7_, _tmp8_, _tmp9_);
	}
	_tmp10_ = argument;
	if (_tmp10_ != NULL) {
...
static void vala_used_attr_check_unused_attr (ValaUsedAttr* self, ValaSymbol* sym) {
	...
	_tmp0_ = sym;
	_tmp1_ = vala_symbol_get_used (_tmp0_);
	_tmp2_ = _tmp1_;
	if (_tmp2_) {
		ValaSymbol* _tmp3_ = NULL;
		GList* _tmp4_ = NULL;
		_tmp3_ = sym;
		_tmp4_ = ((ValaCodeNode*) _tmp3_)->attributes;
		{
			...
			for (attr_it = attr_collection; attr_it != NULL; attr_it = attr_it->next) {
				...
				attr = (ValaAttribute*) attr_it->data;
				{
					...
					_tmp8_ = _tmp7_;
					_tmp9_ = vala_map_get (_tmp5_, _tmp8_);
					set = (ValaSet*) _tmp9_;
					_tmp10_ = set;
					if (_tmp10_ == NULL) {
						...
						_tmp16_ = _tmp15_;
						_tmp17_ = g_strdup_printf ("attribute `%s' never used", _tmp16_);
						_tmp18_ = _tmp17_;
						vala_report_warning (_tmp13_, _tmp18_);
						_g_free0 (_tmp18_);
					} else {
						{
							ValaIterator* _arg_it = NULL;
							ValaAttribute* _tmp19_ = NULL;
							ValaMap* _tmp20_ = NULL;
							...
							_tmp21_ = vala_map_get_keys (_tmp20_);
							_tmp22_ = _tmp21_;
							...
							while (TRUE) {
								...
								_tmp29_ = set;
								_tmp30_ = arg;
								_tmp31_ = vala_collection_contains ((ValaCollection*) _tmp29_, _tmp30_);
								if (!_tmp31_) {
									...
									_tmp34_ = _tmp33_;
									_tmp35_ = arg;
									_tmp36_ = g_strdup_printf ("argument `%s' never used", _tmp35_);
									_tmp37_ = _tmp36_;
									vala_report_warning (_tmp34_, _tmp37_);
									_g_free0 (_tmp37_);
								}
								_g_free0 (arg);
							}
...
static void vala_used_attr_real_visit_namespace (ValaCodeVisitor* base, ValaNamespace* ns) {
	...
	_tmp0_ = ns;
	vala_used_attr_check_unused_attr (self, (ValaSymbol*) _tmp0_);
	_tmp1_ = ns;
...
static void vala_used_attr_class_init (ValaUsedAttrClass * klass) {
	vala_used_attr_parent_class = g_type_class_peek_parent (klass);
	((ValaCodeVisitorClass *) klass)->finalize = vala_used_attr_finalize;
	((ValaCodeVisitorClass *) klass)->visit_namespace = vala_used_attr_real_visit_namespace;
	((ValaCodeVisitorClass *) klass)->visit_class = vala_used_attr_real_visit_class;
	((ValaCodeVisitorClass *) klass)->visit_struct = vala_used_attr_real_visit_struct;
	((ValaCodeVisitorClass *) klass)->visit_interface = vala_used_attr_real_visit_interface;
	((ValaCodeVisitorClass *) klass)->visit_enum = vala_used_attr_real_visit_enum;
	((ValaCodeVisitorClass *) klass)->visit_error_domain = vala_used_attr_real_visit_error_domain;
	((ValaCodeVisitorClass *) klass)->visit_delegate = vala_used_attr_real_visit_delegate;
	((ValaCodeVisitorClass *) klass)->visit_constant = vala_used_attr_real_visit_constant;
	((ValaCodeVisitorClass *) klass)->visit_field = vala_used_attr_real_visit_field;
	((ValaCodeVisitorClass *) klass)->visit_method = vala_used_attr_real_visit_method;
	((ValaCodeVisitorClass *) klass)->visit_creation_method = vala_used_attr_real_visit_creation_method;
	((ValaCodeVisitorClass *) klass)->visit_formal_parameter = vala_used_attr_real_visit_formal_parameter;
	((ValaCodeVisitorClass *) klass)->visit_property = vala_used_attr_real_visit_property;
	((ValaCodeVisitorClass *) klass)->visit_signal = vala_used_attr_real_visit_signal;
}


static void vala_used_attr_instance_init (ValaUsedAttr * self) {
 ...
 */
GType vala_used_attr_get_type (void) {
